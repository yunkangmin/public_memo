...
### 쿠버네티스 사용하기 
  ...
  - 파드만들기
    ...
    ![image](https://github.com/user-attachments/assets/3ecc0467-8f23-44a8-83ac-0d5f7252328c)
  - 파드 정보 확인
    - kubectl get pods
    ![image](https://github.com/user-attachments/assets/4263a19a-470b-405a-8875-c4e4eb3a65c2)
      - 파드를 생성했는데 STATUS가 계속 ContainerCreating일 때
      ```
      NAME        READY   STATUS              RESTARTS   AGE
      webserver   0/1     ContainerCreating   0          13m
      ```
        - 해결방법
          - https://velog.io/@cldta14/FailedCreatePodSandBox
    - 파드 정보 더 자세히 보기
      - kubectl describe pod webserver
      ![image](https://github.com/user-attachments/assets/2b6e2277-ffb0-42fd-9f84-ad08570a8ab8)
